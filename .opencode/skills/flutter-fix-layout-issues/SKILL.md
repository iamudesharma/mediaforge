...
description: Use when diagnosing or fixing Flutter layout errors such as "RenderFlex overflowed", "Vertical viewport was given unbounded height", "An InputDecorator...cannot have an unbounded width", "Incorrect use of ParentData widget", or "RenderBox was not laid out". Covers Expanded, Flexible, SizedBox, and ParentData widget placement (Positioned in Stack, Expanded in Row/Column). Use when the user reports yellow-and-black overflow stripes or any constraint violation in the debug console.
metadata:
  model: deepseek/deepseek-chat
  source: https://github.com/flutter/skills/blob/main/skills/flutter-fix-layout-issues/SKILL.md
