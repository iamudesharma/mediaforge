...
class OutputPaths {
  ...
  static Future<OutputPaths> resolve() async {
    ...
    if (!kIsWeb && (Platform.isAndroid || Platform.isIOS)) {
      ...
      final root = p.join(docs.path, 'flutter_video_processor_example', 'output');
    ...
    for (final start in candidates) {
      ...
      for (var i = 0; i < 6; i++) {
        ...
        if (pubspec.existsSync()) {
          ...
          if (name == 'flutter_video_processor_example') {
            return dir.path;
          }
        }
  ...
  static Future<String> studioScratchDir() async {
    ...
    final dir = Directory(p.join(base.path, 'flutter_video_processor_studio'));
