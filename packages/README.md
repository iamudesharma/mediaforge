...
| `image_forge_editor` | [`image_forge_editor/`](image_forge_editor/) | Editor UI + assets (P0.4) | [rust_image/example/](../rust_image/example/) |
| `image_forge_camera` | [`image_forge_camera/`](image_forge_camera/) | Live camera stream (P0.5) | Editor Beauty → Live camera |
| `rust_image` (shim) | [`../rust_image/`](../rust_image/) | Re-exports `image_forge_editor` | Same as editor |
