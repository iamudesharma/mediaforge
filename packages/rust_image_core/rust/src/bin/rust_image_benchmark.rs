...
use rust_image_core::benchmark::{self, BenchConfig, PreviewProfileMode};
...
fn run() -> Result<(), String> {
    rust_image_core::runtime::configure_runtime();
...
fn print_help() {
    eprintln!(
        r#"rust_image_benchmark — measure each API (CPU vs GPU where supported)

Usage:
  cargo run --release --features gpu --bin rust_image_benchmark -- [OPTIONS]
