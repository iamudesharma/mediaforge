...
use rust_image_core::api::image::ProcessingBackend;
use rust_image_core::runtime::{configure_runtime, pool_enabled, runtime_flags_label};
...
fn decode_encode_works_with_pool_disabled() {
    ...
    let info = rust_image_core::api::advanced::probe_image(src)
