...
A new Flutter FFI plugin project.
  ...
  s.resource_bundles = { 'rust_image_core_mediapipe' => ['../darwin/Resources/mediapipe/**'] }
  ...
  rust_ldflags = '$(inherited) -force_load "$(PODS_CONFIGURATION_BUILD_DIR)/rust_image_core/librust_image_core.a" -Wl,-u,_frb_get_rust_content_hash -Wl,-u,_rust_image_link_rust_for_frb'
