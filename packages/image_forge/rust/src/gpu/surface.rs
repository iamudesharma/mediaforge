...
pub fn apply_surface_beauty_pipeline(
    ...
    #[cfg(feature = "gpu")]
    {
        ...
        let lip_mask = if params.lip_tint_strength > 0.001 || params.lip_plump > 0.001 {
        ...
        let under_eye_mask = if params.under_eye > 0.001 {
            Some(build_under_eye_mask(analysis, w, h))
        } else {
            None
        };
